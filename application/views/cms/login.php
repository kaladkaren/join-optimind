...
<body class="login-body">
  <div class="container">
    <center>
      <img src="<?php echo base_url() ?>public/admin/img/optimind-logo-dark.png" alt="" style="max-height:150px; margin-top: 80px; margin-bottom: -70px; width: 400px;">
    </center>
    <form class="form-signin" method="post" action="<?php echo base_url('cms/login/attempt') ?>">
      <h2 class="form-signin-heading" style="background: dimgray;"> JOIN CMS LOGIN
        <!-- <img src="" alt=""
